...
public class SubtractionL2 : MonoBehaviour
{
    ...
    {
        num1 = Random.Range(10, 20);                          //Set the right side of the question to a random between 0 and 10
        num2 = Random.Range(10, 20);                          //Set the left side of the question to a random between -10 and 10 
        Operator = 2;                                       //Set the operator of the question
        switch (Operator)
        {
