...
public class MultiplicationL3 : MonoBehaviour
{
    ...
    {
        num1 = Random.Range(5, 15);                          //Set the right side of the question to a random between 0 and 10
        num2 = Random.Range(5, 15);                          //Set the left side of the question to a random between -10 and 10 
