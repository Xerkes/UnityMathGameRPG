...
public class MultiplicationL2 : MonoBehaviour
{
    ...
    {
        num1 = Random.Range(2, 10);                          //Set the right side of the question to a random between 0 and 10
        num2 = Random.Range(2, 10);                          //Set the left side of the question to a random between -10 and 10 
        Operator = 1;                                       //Set the operator of the question
        switch (Operator)
        {
