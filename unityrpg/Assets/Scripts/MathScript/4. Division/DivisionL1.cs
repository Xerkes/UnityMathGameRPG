...
public class DivisionL1 : MonoBehaviour
{
    ...
    public void SetQuestions()
    {
        ...
        num2 = Random.Range(2, 2);                          //Set the left side of the question to a random between -10 and 10 
        Operator = 4;                                       //Set the operator of the question
        switch (Operator)
        {
